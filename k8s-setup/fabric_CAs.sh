...
# Launch Fabric Certificate Authorities (CAs)
function launch_ECert_CAs() {
  ...
  log "Waiting for CA deployments to be ready..."
...
# Initialize TLS certificate issuers
...
# Enroll a bootstrap ECert CA user
...
# Enroll bootstrap ECert CA users for all organizations
